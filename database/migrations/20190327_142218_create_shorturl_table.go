...
func (m *CreateShorturlTable_20190327_142218) Up() {
	...
	m.SQL("CREATE TABLE `tb_shorturl` (`id` int(11) unsigned NOT NULL,`hash_id` char(10) DEFAULT NULL COMMENT '哈希ID',`url` varchar(255) DEFAULT NULL COMMENT 'URL地址',`host` varchar(255) DEFAULT NULL COMMENT '域名',`create_time` timestamp NULL DEFAULT NULL COMMENT '创建时间',`create_user_id` varchar(50) DEFAULT NULL COMMENT '创建用户',PRIMARY KEY (`id`),KEY `url` (`url`),KEY `hash_id` (`hash_id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8;")
}
